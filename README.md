...
| `LORE_BEDROCK_MODEL` | `us.anthropic.claude-sonnet-4-6` | Override the inference / adjudication model. The `us.` prefix is a cross-region inference profile, required for Claude 4.x on Bedrock. |
